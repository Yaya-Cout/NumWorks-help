...
PANDOC_OPTIONS="-V toc-title:Sommaire --table-of-contents --number-sections --toc-depth 5 --shift-heading-level-by -1 -V colorlinks=true"
# PANDOC_OPTIONS="--pdf-engine=lualatex -V documentclass=scrartcl -V author="" -V title="" --include-in-header=preamble.sty"
